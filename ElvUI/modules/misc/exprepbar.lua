...
function M:LoadExpRepBar()
	self.expBar = self:CreateBar('ElvUI_ExperienceBar', ExperienceBar_OnEnter, 'TOP', MMHolder, 'BOTTOM', 0, -12)
	...
	self.repBar = self:CreateBar('ElvUI_ReputationBar', ReputationBar_OnEnter, 'TOP', MMHolder, 'BOTTOM', 0, 0)
