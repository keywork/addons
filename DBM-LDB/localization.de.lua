...
DBM_LDB_CAT_WOD			= "Kriegshäuptlinge von Draenor"
DBM_LDB_CAT_MOP			= "Die Nebel von Pandaria"
DBM_LDB_CAT_CATA		= "Kataklysmus"
DBM_LDB_CAT_WOTLK		= "Zorn des Lichkönigs"
DBM_LDB_CAT_BC			= "Der Brennende Kreuzzug"
DBM_LDB_CAT_CLASSIC 	= "Klassik"
