--[[
	...
	Version: 7.0.5637 (TasmanianThylacine)
	Revision: $Id: EnxMain.lua 5617 2016-07-26 23:39:46Z ccox $
...
Enchantrix_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Enchantrix/EnxMain.lua $", "$Rev: 5617 $")
...
function addonLoaded(hookArgs, event, addOnName)
	...
	Enchantrix.Revision = Enchantrix.Util.GetRevision("$Revision: 5617 $")
