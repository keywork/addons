--[[
	...
	Revision: $Id: EnxStorage.lua 5617 2016-07-26 23:39:46Z ccox $
...
Enchantrix_RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Enchantrix/EnxStorage.lua $", "$Rev: 5617 $")
