--[[
	...
	Revision: $Id: BeanCounterAPI.lua 5594 2016-04-21 13:26:33Z brykrys $
...
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/auctioneer/trunk/BeanCounter/BeanCounterAPI.lua $","$Rev: 5594 $","5.1.DEV.", 'auctioneer', 'libs')
