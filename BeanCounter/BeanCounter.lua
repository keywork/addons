--[[
	...
	Revision: $Id: BeanCounter.lua 5637 2016-08-02 20:22:42Z brykrys $
...
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/auctioneer/trunk/BeanCounter/BeanCounter.lua $","$Rev: 5637 $","5.1.DEV.", 'auctioneer', 'libs')
